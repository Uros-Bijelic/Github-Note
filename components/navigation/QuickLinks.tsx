...
const QuickLinks: React.FC<IQuickLinksProps> = ({ githubUrl }) => {
  return (
    <div className="flex flex-1 flex-col">
      ...
      <Button
        className="p3-medium flex items-center justify-start gap-3 bg-transparent p-0 text-white-500! shadow-none! hover:bg-transparent cursor-pointer focus:ring-0 ring-0"
